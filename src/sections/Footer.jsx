    ...
    <section className='max-container'>
      <div className='flex gap-20 flex-wrap max-lg:flex-col'>\
        <div className='flex flex-col items-start'>
          ...
          <div className='flex flex-1 justify-bentween lg:gap-10 gap-20 flex-wrap'>
      ...
      <div className='flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center'>
        <div className='flex flex-row font-montserrat text-white'>Built by <span className='font-semibold'>&nbsp; Shashwat Kapoor </span>&nbsp; using <span className='font-semibold'>&nbsp; React & TailwindCSS. </span></div>
